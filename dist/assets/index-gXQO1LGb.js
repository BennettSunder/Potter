...
`)+`
`+p);const T=S+m+o,E=S+p+a,A=tc(s,s.VERTEX_SHADER,T),R=tc(s,s.FRAGMENT_SHADER,E);s.attachShader(x,A),s.attachShader(x,R),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function C(P){if(i.debug.checkShaderErrors){const z=s.getProgramInfoLog(x)||"",U=s.getShaderInfoLog(A)||"",V=s.getShaderInfoLog(R)||"",G=z.trim(),k=U.trim(),H=V.trim();let J=!0,ae=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(J=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,A,R);else{const se=ic(s,A,"vertex"),j=ic(s,R,"fragment");We("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
Program Info Log: `+G+`
`+se+`
`+j)}else G!==""?De("WebGLProgram: Program Info Log:",G):(k===""||H==="")&&(ae=!1);ae&&(P.diagnostics={runnable:J,programLog:G,vertexShader:{log:k,prefix:m},fragmentShader:{log:H,prefix:p}})}s.deleteShader(A),s.deleteShader(R),N=new Ls(s,x),v=mm(s,x)}let N;this.getUniforms=function(){return N===void 0&&C(this),N};let v;this.getAttributes=function(){return v===void 0&&C(this),v};let y=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return y===!1&&(y=s.getProgramParameter(x,rm)),y},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(x),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=om++,this.cacheKey=e,this.usedTimes=1,this.program=x,this.vertexShader=A,this.fragmentShader=R,this}let Im=0;class Dm{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,s=this._getShaderStage(t),r=this._getShaderStage(n),o=this._getShaderCacheForMaterial(e);return o.has(s)===!1&&(o.add(s),s.usedTimes++),o.has(r)===!1&&(o.add(r),r.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new Lm(e),t.set(e,n)),n}}class Lm{constructor(e){this.id=Im++,this.code=e,this.usedTimes=0}}function Um(i,e,t,n,s,r,o){const a=new Ho,l=new Dm,c=new Set,h=[],d=new Map,u=s.logarithmicDepthBuffer;let f=s.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function x(v){return c.add(v),v===0?"uv":`uv${v}`}function m(v,y,P,z,U){const V=z.fog,G=U.geometry,k=v.isMeshStandardMaterial?z.environment:null,H=(v.isMeshStandardMaterial?t:e).get(v.envMap||k),J=H&&H.mapping===Gs?H.image.height:null,ae=g[v.type];v.precision!==null&&(f=s.getMaxPrecision(v.precision),f!==v.precision&&De("WebGLProgram.getParameters:",v.precision,"not supported, using",f,"instead."));const se=G.morphAttributes.position||G.morphAttributes.normal||G.morphAttributes.color,j=se!==void 0?se.length:0;let Se=0;G.morphAttributes.position!==void 0&&(Se=1),G.morphAttributes.normal!==void 0&&(Se=2),G.morphAttributes.color!==void 0&&(Se=3);let ge,Ue,O,W;if(ae){const $e=tn[ae];ge=$e.vertexShader,Ue=$e.fragmentShader}else ge=v.vertexShader,Ue=v.fragmentShader,l.update(v),O=l.getVertexShaderID(v),W=l.getFragmentShaderID(v);const Y=i.getRenderTarget(),ne=i.state.buffers.depth.getReversed(),re=U.isInstancedMesh===!0,me=U.isBatchedMesh===!0,Ne=!!v.map,ot=!!v.matcap,He=!!H,je=!!v.aoMap,et=!!v.lightMap,Be=!!v.bumpMap,ft=!!v.normalMap,I=!!v.displacementMap,pt=!!v.emissiveMap,Ye=!!v.metalnessMap,nt=!!v.roughnessMap,be=v.anisotropy>0,b=v.clearcoat>0,_=v.dispersion>0,L=v.iridescence>0,K=v.sheen>0,Q=v.transmission>0,$=be&&!!v.anisotropyMap,Te=b&&!!v.clearcoatMap,ce=b&&!!v.clearcoatNormalMap,ye=b&&!!v.clearcoatRoughnessMap,Ie=L&&!!v.iridescenceMap,te=L&&!!v.iridescenceThicknessMap,he=K&&!!v.sheenColorMap,Me=K&&!!v.sheenRoughnessMap,Ee=!!v.specularMap,le=!!v.specularColorMap,Ve=!!v.specularIntensityMap,D=Q&&!!v.transmissionMap,pe=Q&&!!v.thicknessMap,ie=!!v.gradientMap,_e=!!v.alphaMap,ee=v.alphaTest>0,Z=!!v.alphaHash,oe=!!v.extensions;let Le=rn;v.toneMapped&&(Y===null||Y.isXRRenderTarget===!0)&&(Le=i.toneMapping);const it={shaderID:ae,shaderType:v.type,shaderName:v.name,vertexShader:ge,fragmentShader:Ue,defines:v.defines,customVertexShaderID:O,customFragmentShaderID:W,isRawShaderMaterial:v.isRawShaderMaterial===!0,glslVersion:v.glslVersion,precision:f,batching:me,batchingColor:me&&U._colorsTexture!==null,instancing:re,instancingColor:re&&U.instanceColor!==null,instancingMorph:re&&U.morphTexture!==null,outputColorSpace:Y===null?i.outputColorSpace:Y.isXRRenderTarget===!0?Y.texture.colorSpace:vi,alphaToCoverage:!!v.alphaToCoverage,map:Ne,matcap:ot,envMap:He,envMapMode:He&&H.mapping,envMapCubeUVHeight:J,aoMap:je,lightMap:et,bumpMap:Be,normalMap:ft,displacementMap:I,emissiveMap:pt,normalMapObjectSpace:ft&&v.normalMapType===gh,normalMapTangentSpace:ft&&v.normalMapType===Xc,metalnessMap:Ye,roughnessMap:nt,anisotropy:be,anisotropyMap:$,clearcoat:b,clearcoatMap:Te,clearcoatNormalMap:ce,clearcoatRoughnessMap:ye,dispersion:_,iridescence:L,iridescenceMap:Ie,iridescenceThicknessMap:te,sheen:K,sheenColorMap:he,sheenRoughnessMap:Me,specularMap:Ee,specularColorMap:le,specularIntensityMap:Ve,transmission:Q,transmissionMap:D,thicknessMap:pe,gradientMap:ie,opaque:v.transparent===!1&&v.blending===fi&&v.alphaToCoverage===!1,alphaMap:_e,alphaTest:ee,alphaHash:Z,combine:v.combine,mapUv:Ne&&x(v.map.channel),aoMapUv:je&&x(v.aoMap.channel),lightMapUv:et&&x(v.lightMap.channel),bumpMapUv:Be&&x(v.bumpMap.channel),normalMapUv:ft&&x(v.normalMap.channel),displacementMapUv:I&&x(v.displacementMap.channel),emissiveMapUv:pt&&x(v.emissiveMap.channel),metalnessMapUv:Ye&&x(v.metalnessMap.channel),roughnessMapUv:nt&&x(v.roughnessMap.channel),anisotropyMapUv:$&&x(v.anisotropyMap.channel),clearcoatMapUv:Te&&x(v.clearcoatMap.channel),clearcoatNormalMapUv:ce&&x(v.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ye&&x(v.clearcoatRoughnessMap.channel),iridescenceMapUv:Ie&&x(v.iridescenceMap.channel),iridescenceThicknessMapUv:te&&x(v.iridescenceThicknessMap.channel),sheenColorMapUv:he&&x(v.sheenColorMap.channel),sheenRoughnessMapUv:Me&&x(v.sheenRoughnessMap.channel),specularMapUv:Ee&&x(v.specularMap.channel),specularColorMapUv:le&&x(v.specularColorMap.channel),specularIntensityMapUv:Ve&&x(v.specularIntensityMap.channel),transmissionMapUv:D&&x(v.transmissionMap.channel),thicknessMapUv:pe&&x(v.thicknessMap.channel),alphaMapUv:_e&&x(v.alphaMap.channel),vertexTangents:!!G.attributes.tangent&&(ft||be),vertexColors:v.vertexColors,vertexAlphas:v.vertexColors===!0&&!!G.attributes.color&&G.attributes.color.itemSize===4,pointsUvs:U.isPoints===!0&&!!G.attributes.uv&&(Ne||_e),fog:!!V,useFog:v.fog===!0,fogExp2:!!V&&V.isFogExp2,flatShading:v.flatShading===!0&&v.wireframe===!1,sizeAttenuation:v.sizeAttenuation===!0,logarithmicDepthBuffer:u,reversedDepthBuffer:ne,skinning:U.isSkinnedMesh===!0,morphTargets:G.morphAttributes.position!==void 0,morphNormals:G.morphAttributes.normal!==void 0,morphColors:G.morphAttributes.color!==void 0,morphTargetsCount:j,morphTextureStride:Se,numDirLights:y.directional.length,numPointLights:y.point.length,numSpotLights:y.spot.length,numSpotLightMaps:y.spotLightMap.length,numRectAreaLights:y.rectArea.length,numHemiLights:y.hemi.length,numDirLightShadows:y.directionalShadowMap.length,numPointLightShadows:y.pointShadowMap.length,numSpotLightShadows:y.spotShadowMap.length,numSpotLightShadowsWithMaps:y.numSpotLightShadowsWithMaps,numLightProbes:y.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:v.dithering,shadowMapEnabled:i.shadowMap.enabled&&P.length>0,shadowMapType:i.shadowMap.type,toneMapping:Le,decodeVideoTexture:Ne&&v.map.isVideoTexture===!0&&Xe.getTransfer(v.map.colorSpace)===Ze,decodeVideoTextureEmissive:pt&&v.emissiveMap.isVideoTexture===!0&&Xe.getTransfer(v.emissiveMap.colorSpace)===Ze,premultipliedAlpha:v.premultipliedAlpha,doubleSided:v.side===qt,flipSided:v.side===Ct,useDepthPacking:v.depthPacking>=0,depthPacking:v.depthPacking||0,index0AttributeName:v.index0AttributeName,extensionClipCullDistance:oe&&v.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(oe&&v.extensions.multiDraw===!0||me)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:v.customProgramCacheKey()};return it.vertexUv1s=c.has(1),it.vertexUv2s=c.has(2),it.vertexUv3s=c.has(3),c.clear(),it}function p(v){const y=[];if(v.shaderID?y.push(v.shaderID):(y.push(v.customVertexShaderID),y.push(v.customFragmentShaderID)),v.defines!==void 0)for(const P in v.defines)y.push(P),y.push(v.defines[P]);return v.isRawShaderMaterial===!1&&(S(y,v),T(y,v),y.push(i.outputColorSpace)),y.push(v.customProgramCacheKey),y.join()}function S(v,y){v.push(y.precision),v.push(y.outputColorSpace),v.push(y.envMapMode),v.push(y.envMapCubeUVHeight),v.push(y.mapUv),v.push(y.alphaMapUv),v.push(y.lightMapUv),v.push(y.aoMapUv),v.push(y.bumpMapUv),v.push(y.normalMapUv),v.push(y.displacementMapUv),v.push(y.emissiveMapUv),v.push(y.metalnessMapUv),v.push(y.roughnessMapUv),v.push(y.anisotropyMapUv),v.push(y.clearcoatMapUv),v.push(y.clearcoatNormalMapUv),v.push(y.clearcoatRoughnessMapUv),v.push(y.iridescenceMapUv),v.push(y.iridescenceThicknessMapUv),v.push(y.sheenColorMapUv),v.push(y.sheenRoughnessMapUv),v.push(y.specularMapUv),v.push(y.specularColorMapUv),v.push(y.specularIntensityMapUv),v.push(y.transmissionMapUv),v.push(y.thicknessMapUv),v.push(y.combine),v.push(y.fogExp2),v.push(y.sizeAttenuation),v.push(y.morphTargetsCount),v.push(y.morphAttributeCount),v.push(y.numDirLights),v.push(y.numPointLights),v.push(y.numSpotLights),v.push(y.numSpotLightMaps),v.push(y.numHemiLights),v.push(y.numRectAreaLights),v.push(y.numDirLightShadows),v.push(y.numPointLightShadows),v.push(y.numSpotLightShadows),v.push(y.numSpotLightShadowsWithMaps),v.push(y.numLightProbes),v.push(y.shadowMapType),v.push(y.toneMapping),v.push(y.numClippingPlanes),v.push(y.numClipIntersection),v.push(y.depthPacking)}function T(v,y){a.disableAll(),y.instancing&&a.enable(0),y.instancingColor&&a.enable(1),y.instancingMorph&&a.enable(2),y.matcap&&a.enable(3),y.envMap&&a.enable(4),y.normalMapObjectSpace&&a.enable(5),y.normalMapTangentSpace&&a.enable(6),y.clearcoat&&a.enable(7),y.iridescence&&a.enable(8),y.alphaTest&&a.enable(9),y.vertexColors&&a.enable(10),y.vertexAlphas&&a.enable(11),y.vertexUv1s&&a.enable(12),y.vertexUv2s&&a.enable(13),y.vertexUv3s&&a.enable(14),y.vertexTangents&&a.enable(15),y.anisotropy&&a.enable(16),y.alphaHash&&a.enable(17),y.batching&&a.enable(18),y.dispersion&&a.enable(19),y.batchingColor&&a.enable(20),y.gradientMap&&a.enable(21),v.push(a.mask),a.disableAll(),y.fog&&a.enable(0),y.useFog&&a.enable(1),y.flatShading&&a.enable(2),y.logarithmicDepthBuffer&&a.enable(3),y.reversedDepthBuffer&&a.enable(4),y.skinning&&a.enable(5),y.morphTargets&&a.enable(6),y.morphNormals&&a.enable(7),y.morphColors&&a.enable(8),y.premultipliedAlpha&&a.enable(9),y.shadowMapEnabled&&a.enable(10),y.doubleSided&&a.enable(11),y.flipSided&&a.enable(12),y.useDepthPacking&&a.enable(13),y.dithering&&a.enable(14),y.transmission&&a.enable(15),y.sheen&&a.enable(16),y.opaque&&a.enable(17),y.pointsUvs&&a.enable(18),y.decodeVideoTexture&&a.enable(19),y.decodeVideoTextureEmissive&&a.enable(20),y.alphaToCoverage&&a.enable(21),v.push(a.mask)}function E(v){const y=g[v.type];let P;if(y){const z=tn[y];P=Xh.clone(z.uniforms)}else P=v.uniforms;return P}function A(v,y){let P=d.get(y);return P!==void 0?++P.usedTimes:(P=new Pm(i,y,v,r),h.push(P),d.set(y,P)),P}function R(v){if(--v.usedTimes===0){const y=h.indexOf(v);h[y]=h[h.length-1],h.pop(),d.delete(v.cacheKey),v.destroy()}}function C(v){l.remove(v)}function N(){l.dispose()}return{getParameters:m,getProgramCacheKey:p,getUniforms:E,acquireProgram:A,releaseProgram:R,releaseShaderCache:C,programs:h,dispose:N}}function Fm(){let i=new WeakMap;function e(o){return i.has(o)}function t(o){let a=i.get(o);return a===void 0&&(a={},i.set(o,a)),a}function n(o){i.delete(o)}function s(o,a,l){i.get(o)[a]=l}function r(){i=new WeakMap}return{has:e,get:t,remove:n,update:s,dispose:r}}function Nm(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.z!==e.z?i.z-e.z:i.id-e.id}function cc(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function lc(){const i=[];let e=0;const t=[],n=[],s=[];function r(){e=0,t.length=0,n.length=0,s.length=0}function o(d,u,f,g,x,m){let p=i[e];return p===void 0?(p={id:d.id,object:d,geometry:u,material:f,groupOrder:g,renderOrder:d.renderOrder,z:x,group:m},i[e]=p):(p.id=d.id,p.object=d,p.geometry=u,p.material=f,p.groupOrder=g,p.renderOrder=d.renderOrder,p.z=x,p.group=m),e++,p}function a(d,u,f,g,x,m){const p=o(d,u,f,g,x,m);f.transmission>0?n.push(p):f.transparent===!0?s.push(p):t.push(p)}function l(d,u,f,g,x,m){const p=o(d,u,f,g,x,m);f.transmission>0?n.unshift(p):f.transparent===!0?s.unshift(p):t.unshift(p)}function c(d,u){t.length>1&&t.sort(d||Nm),n.length>1&&n.sort(u||cc),s.length>1&&s.sort(u||cc)}function h(){for(let d=e,u=i.length;d<u;d++){const f=i[d];if(f.id===null)break;f.id=null,f.object=null,f.geometry=null,f.material=null,f.group=null}}return{opaque:t,transmissive:n,transparent:s,init:r,push:a,unshift:l,finish:h,sort:c}}function Om(){let i=new WeakMap;function e(n,s){const r=i.get(n);let o;return r===void 0?(o=new lc,i.set(n,[o])):s>=r.length?(o=new lc,r.push(o)):o=r[s],o}function t(){i=new WeakMap}return{get:e,dispose:t}}function zm(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new w,color:new ze};break;case"SpotLight":t={position:new w,direction:new w,color:new ze,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new w,color:new ze,distance:0,decay:0};break;case"HemisphereLight":t={direction:new w,skyColor:new ze,groundColor:new ze};break;case"RectAreaLight":t={color:new ze,position:new w,halfWidth:new w,halfHeight:new w};break}return i[e.id]=t,t}}}function Bm(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ce};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ce};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ce,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let Vm=0;function km(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function Gm(i){const e=new zm,t=Bm(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new w);const s=new w,r=new lt,o=new lt;function a(c){let h=0,d=0,u=0;for(let v=0;v<9;v++)n.probe[v].set(0,0,0);let f=0,g=0,x=0,m=0,p=0,S=0,T=0,E=0,A=0,R=0,C=0;c.sort(km);for(let v=0,y=c.length;v<y;v++){const P=c[v],z=P.color,U=P.intensity,V=P.distance;let G=null;if(P.shadow&&P.shadow.map&&(P.shadow.map.texture.format===xi?G=P.shadow.map.texture:G=P.shadow.map.depthTexture||P.shadow.map.texture),P.isAmbientLight)h+=z.r*U,d+=z.g*U,u+=z.b*U;else if(P.isLightProbe){for(let k=0;k<9;k++)n.probe[k].addScaledVector(P.sh.coefficients[k],U);C++}else if(P.isDirectionalLight){const k=e.get(P);if(k.color.copy(P.color).multiplyScalar(P.intensity),P.castShadow){const H=P.shadow,J=t.get(P);J.shadowIntensity=H.intensity,J.shadowBias=H.bias,J.shadowNormalBias=H.normalBias,J.shadowRadius=H.radius,J.shadowMapSize=H.mapSize,n.directionalShadow[f]=J,n.directionalShadowMap[f]=G,n.directionalShadowMatrix[f]=P.shadow.matrix,S++}n.directional[f]=k,f++}else if(P.isSpotLight){const k=e.get(P);k.position.setFromMatrixPosition(P.matrixWorld),k.color.copy(z).multiplyScalar(U),k.distance=V,k.coneCos=Math.cos(P.angle),k.penumbraCos=Math.cos(P.angle*(1-P.penumbra)),k.decay=P.decay,n.spot[x]=k;const H=P.shadow;if(P.map&&(n.spotLightMap[A]=P.map,A++,H.updateMatrices(P),P.castShadow&&R++),n.spotLightMatrix[x]=H.matrix,P.castShadow){const J=t.get(P);J.shadowIntensity=H.intensity,J.shadowBias=H.bias,J.shadowNormalBias=H.normalBias,J.shadowRadius=H.radius,J.shadowMapSize=H.mapSize,n.spotShadow[x]=J,n.spotShadowMap[x]=G,E++}x++}else if(P.isRectAreaLight){const k=e.get(P);k.color.copy(z).multiplyScalar(U),k.halfWidth.set(P.width*.5,0,0),k.halfHeight.set(0,P.height*.5,0),n.rectArea[m]=k,m++}else if(P.isPointLight){const k=e.get(P);if(k.color.copy(P.color).multiplyScalar(P.intensity),k.distance=P.distance,k.decay=P.decay,P.castShadow){const H=P.shadow,J=t.get(P);J.shadowIntensity=H.intensity,J.shadowBias=H.bias,J.shadowNormalBias=H.normalBias,J.shadowRadius=H.radius,J.shadowMapSize=H.mapSize,J.shadowCameraNear=H.camera.near,J.shadowCameraFar=H.camera.far,n.pointShadow[g]=J,n.pointShadowMap[g]=G,n.pointShadowMatrix[g]=P.shadow.matrix,T++}n.point[g]=k,g++}else if(P.isHemisphereLight){const k=e.get(P);k.skyColor.copy(P.color).multiplyScalar(U),k.groundColor.copy(P.groundColor).multiplyScalar(U),n.hemi[p]=k,p++}}m>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=ue.LTC_FLOAT_1,n.rectAreaLTC2=ue.LTC_FLOAT_2):(n.rectAreaLTC1=ue.LTC_HALF_1,n.rectAreaLTC2=ue.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=d,n.ambient[2]=u;const N=n.hash;(N.directionalLength!==f||N.pointLength!==g||N.spotLength!==x||N.rectAreaLength!==m||N.hemiLength!==p||N.numDirectionalShadows!==S||N.numPointShadows!==T||N.numSpotShadows!==E||N.numSpotMaps!==A||N.numLightProbes!==C)&&(n.directional.length=f,n.spot.length=x,n.rectArea.length=m,n.point.length=g,n.hemi.length=p,n.directionalShadow.length=S,n.directionalShadowMap.length=S,n.pointShadow.length=T,n.pointShadowMap.length=T,n.spotShadow.length=E,n.spotShadowMap.length=E,n.directionalShadowMatrix.length=S,n.pointShadowMatrix.length=T,n.spotLightMatrix.length=E+A-R,n.spotLightMap.length=A,n.numSpotLightShadowsWithMaps=R,n.numLightProbes=C,N.directionalLength=f,N.pointLength=g,N.spotLength=x,N.rectAreaLength=m,N.hemiLength=p,N.numDirectionalShadows=S,N.numPointShadows=T,N.numSpotShadows=E,N.numSpotMaps=A,N.numLightProbes=C,n.version=Vm++)}function l(c,h){let d=0,u=0,f=0,g=0,x=0;const m=h.matrixWorldInverse;for(let p=0,S=c.length;p<S;p++){const T=c[p];if(T.isDirectionalLight){const E=n.directional[d];E.direction.setFromMatrixPosition(T.matrixWorld),s.setFromMatrixPosition(T.target.matrixWorld),E.direction.sub(s),E.direction.transformDirection(m),d++}else if(T.isSpotLight){const E=n.spot[f];E.position.setFromMatrixPosition(T.matrixWorld),E.position.applyMatrix4(m),E.direction.setFromMatrixPosition(T.matrixWorld),s.setFromMatrixPosition(T.target.matrixWorld),E.direction.sub(s),E.direction.transformDirection(m),f++}else if(T.isRectAreaLight){const E=n.rectArea[g];E.position.setFromMatrixPosition(T.matrixWorld),E.position.applyMatrix4(m),o.identity(),r.copy(T.matrixWorld),r.premultiply(m),o.extractRotation(r),E.halfWidth.set(T.width*.5,0,0),E.halfHeight.set(0,T.height*.5,0),E.halfWidth.applyMatrix4(o),E.halfHeight.applyMatrix4(o),g++}else if(T.isPointLight){const E=n.point[u];E.position.setFromMatrixPosition(T.matrixWorld),E.position.applyMatrix4(m),u++}else if(T.isHemisphereLight){const E=n.hemi[x];E.direction.setFromMatrixPosition(T.matrixWorld),E.direction.transformDirection(m),x++}}}return{setup:a,setupView:l,state:n}}function hc(i){const e=new Gm(i),t=[],n=[];function s(h){c.camera=h,t.length=0,n.length=0}function r(h){t.push(h)}function o(h){n.push(h)}function a(){e.setup(t)}function l(h){e.setupView(t,h)}const c={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:s,state:c,setupLights:a,setupLightsView:l,pushLight:r,pushShadow:o}}function Hm(i){let e=new WeakMap;function t(s,r=0){const o=e.get(s);let a;return o===void 0?(a=new hc(i),e.set(s,[a])):r>=o.length?(a=new hc(i),o.push(a)):a=o[r],a}function n(){e=new WeakMap}return{get:t,dispose:n}}const Wm=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,qm=[new w(1,0,0),new w(-1,0,0),new w(0,1,0),new w(0,-1,0),new w(0,0,1),new w(0,0,-1)],Ym=[new w(0,-1,0),new w(0,-1,0),new w(0,0,1),new w(0,0,-1),new w(0,-1,0),new w(0,-1,0)],dc=new lt,Li=new w,Rr=new w;function jm(i,e,t){let n=new tl;const s=new Ce,r=new Ce,o=new ut,a=new rd,l=new od,c={},h=t.maxTextureSize,d={[Pn]:Ct,[Ct]:Pn,[qt]:qt},u=new cn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ce},radius:{value:4}},vertexShader:Wm,fragmentShader:Xm}),f=u.clone();f.defines.HORIZONTAL_PASS=1;const g=new ct;g.setAttribute("position",new St(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new at(g,u),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Rs;let p=this.type;this.render=function(R,C,N){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||R.length===0)return;R.type===Yl&&(De("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),R.type=Rs);const v=i.getRenderTarget(),y=i.getActiveCubeFace(),P=i.getActiveMipmapLevel(),z=i.state;z.setBlending(_n),z.buffers.depth.getReversed()===!0?z.buffers.color.setClear(0,0,0,0):z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const U=p!==this.type;U&&C.traverse(function(V){V.material&&(Array.isArray(V.material)?V.material.forEach(G=>G.needsUpdate=!0):V.material.needsUpdate=!0)});for(let V=0,G=R.length;V<G;V++){const k=R[V],H=k.shadow;if(H===void 0){De("WebGLShadowMap:",k,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;s.copy(H.mapSize);const J=H.getFrameExtents();if(s.multiply(J),r.copy(H.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/J.x),s.x=r.x*J.x,H.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/J.y),s.y=r.y*J.y,H.mapSize.y=r.y)),H.map===null||U===!0){if(H.map!==null&&(H.map.depthTexture!==null&&(H.map.depthTexture.dispose(),H.map.depthTexture=null),H.map.dispose()),this.type===Fi){if(k.isPointLight){De("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}H.map=new on(s.x,s.y,{format:xi,type:vn,minFilter:At,magFilter:At,generateMipmaps:!1}),H.map.texture.name=k.name+".shadowMap",H.map.depthTexture=new Hi(s.x,s.y,nn),H.map.depthTexture.name=k.name+".shadowMapDepth",H.map.depthTexture.format=Mn,H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=yt,H.map.depthTexture.magFilter=yt}else{k.isPointLight?(H.map=new el(s.x),H.map.depthTexture=new nd(s.x,an)):(H.map=new on(s.x,s.y),H.map.depthTexture=new Hi(s.x,s.y,an)),H.map.depthTexture.name=k.name+".shadowMap",H.map.depthTexture.format=Mn;const se=i.state.buffers.depth.getReversed();this.type===Rs?(H.map.depthTexture.compareFunction=se?ko:Vo,H.map.depthTexture.minFilter=At,H.map.depthTexture.magFilter=At):(H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=yt,H.map.depthTexture.magFilter=yt)}H.camera.updateProjectionMatrix()}const ae=H.map.isWebGLCubeRenderTarget?6:1;for(let se=0;se<ae;se++){if(H.map.isWebGLCubeRenderTarget)i.setRenderTarget(H.map,se),i.clear();else{se===0&&(i.setRenderTarget(H.map),i.clear());const j=H.getViewport(se);o.set(r.x*j.x,r.y*j.y,r.x*j.z,r.y*j.w),z.viewport(o)}if(k.isPointLight){const j=H.camera,Se=H.matrix,ge=k.distance||j.far;ge!==j.far&&(j.far=ge,j.updateProjectionMatrix()),Li.setFromMatrixPosition(k.matrixWorld),j.position.copy(Li),Rr.copy(j.position),Rr.add(qm[se]),j.up.copy(Ym[se]),j.lookAt(Rr),j.updateMatrixWorld(),Se.makeTranslation(-Li.x,-Li.y,-Li.z),dc.multiplyMatrices(j.projectionMatrix,j.matrixWorldInverse),H._frustum.setFromProjectionMatrix(dc,j.coordinateSystem,j.reversedDepth)}else H.updateMatrices(k);n=H.getFrustum(),E(C,N,H.camera,k,this.type)}H.isPointLightShadow!==!0&&this.type===Fi&&S(H,N),H.needsUpdate=!1}p=this.type,m.needsUpdate=!1,i.setRenderTarget(v,y,P)};function S(R,C){const N=e.update(x);u.defines.VSM_SAMPLES!==R.blurSamples&&(u.defines.VSM_SAMPLES=R.blurSamples,f.defines.VSM_SAMPLES=R.blurSamples,u.needsUpdate=!0,f.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new on(s.x,s.y,{format:xi,type:vn})),u.uniforms.shadow_pass.value=R.map.depthTexture,u.uniforms.resolution.value=R.mapSize,u.uniforms.radius.value=R.radius,i.setRenderTarget(R.mapPass),i.clear(),i.renderBufferDirect(C,null,N,u,x,null),f.uniforms.shadow_pass.value=R.mapPass.texture,f.uniforms.resolution.value=R.mapSize,f.uniforms.radius.value=R.radius,i.setRenderTarget(R.map),i.clear(),i.renderBufferDirect(C,null,N,f,x,null)}function T(R,C,N,v){let y=null;const P=N.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(P!==void 0)y=P;else if(y=N.isPointLight===!0?l:a,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const z=y.uuid,U=C.uuid;let V=c[z];V===void 0&&(V={},c[z]=V);let G=V[U];G===void 0&&(G=y.clone(),V[U]=G,C.addEventListener("dispose",A)),y=G}if(y.visible=C.visible,y.wireframe=C.wireframe,v===Fi?y.side=C.shadowSide!==null?C.shadowSide:C.side:y.side=C.shadowSide!==null?C.shadowSide:d[C.side],y.alphaMap=C.alphaMap,y.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,y.map=C.map,y.clipShadows=C.clipShadows,y.clippingPlanes=C.clippingPlanes,y.clipIntersection=C.clipIntersection,y.displacementMap=C.displacementMap,y.displacementScale=C.displacementScale,y.displacementBias=C.displacementBias,y.wireframeLinewidth=C.wireframeLinewidth,y.linewidth=C.linewidth,N.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const z=i.properties.get(y);z.light=N}return y}function E(R,C,N,v,y){if(R.visible===!1)return;if(R.layers.test(C.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&y===Fi)&&(!R.frustumCulled||n.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(N.matrixWorldInverse,R.matrixWorld);const U=e.update(R),V=R.material;if(Array.isArray(V)){const G=U.groups;for(let k=0,H=G.length;k<H;k++){const J=G[k],ae=V[J.materialIndex];if(ae&&ae.visible){const se=T(R,ae,v,y);R.onBeforeShadow(i,R,C,N,U,se,J),i.renderBufferDirect(N,null,U,se,R,J),R.onAfterShadow(i,R,C,N,U,se,J)}}}else if(V.visible){const G=T(R,V,v,y);R.onBeforeShadow(i,R,C,N,U,G,null),i.renderBufferDirect(N,null,U,G,R,null),R.onAfterShadow(i,R,C,N,U,G,null)}}const z=R.children;for(let U=0,V=z.length;U<V;U++)E(z[U],C,N,v,y)}function A(R){R.target.removeEventListener("dispose",A);for(const N in c){const v=c[N],y=R.target.uuid;y in v&&(v[y].dispose(),delete v[y])}}}const $m={[Ur]:Fr,[Nr]:Br,[Or]:Vr,[gi]:zr,[Fr]:Ur,[Br]:Nr,[Vr]:Or,[zr]:gi};function Km(i,e){function t(){let D=!1;const pe=new ut;let ie=null;const _e=new ut(0,0,0,0);return{setMask:function(ee){ie!==ee&&!D&&(i.colorMask(ee,ee,ee,ee),ie=ee)},setLocked:function(ee){D=ee},setClear:function(ee,Z,oe,Le,it){it===!0&&(ee*=Le,Z*=Le,oe*=Le),pe.set(ee,Z,oe,Le),_e.equals(pe)===!1&&(i.clearColor(ee,Z,oe,Le),_e.copy(pe))},reset:function(){D=!1,ie=null,_e.set(-1,0,0,0)}}}function n(){let D=!1,pe=!1,ie=null,_e=null,ee=null;return{setReversed:function(Z){if(pe!==Z){const oe=e.get("EXT_clip_control");Z?oe.clipControlEXT(oe.LOWER_LEFT_EXT,oe.ZERO_TO_ONE_EXT):oe.clipControlEXT(oe.LOWER_LEFT_EXT,oe.NEGATIVE_ONE_TO_ONE_EXT),pe=Z;const Le=ee;ee=null,this.setClear(Le)}},getReversed:function(){return pe},setTest:function(Z){Z?Y(i.DEPTH_TEST):ne(i.DEPTH_TEST)},setMask:function(Z){ie!==Z&&!D&&(i.depthMask(Z),ie=Z)},setFunc:function(Z){if(pe&&(Z=$m[Z]),_e!==Z){switch(Z){case Ur:i.depthFunc(i.NEVER);break;case Fr:i.depthFunc(i.ALWAYS);break;case Nr:i.depthFunc(i.LESS);break;case gi:i.depthFunc(i.LEQUAL);break;case Or:i.depthFunc(i.EQUAL);break;case zr:i.depthFunc(i.GEQUAL);break;case Br:i.depthFunc(i.GREATER);break;case Vr:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}_e=Z}},setLocked:function(Z){D=Z},setClear:function(Z){ee!==Z&&(pe&&(Z=1-Z),i.clearDepth(Z),ee=Z)},reset:function(){D=!1,ie=null,_e=null,ee=null,pe=!1}}}function s(){let D=!1,pe=null,ie=null,_e=null,ee=null,Z=null,oe=null,Le=null,it=null;return{setTest:function($e){D||($e?Y(i.STENCIL_TEST):ne(i.STENCIL_TEST))},setMask:function($e){pe!==$e&&!D&&(i.stencilMask($e),pe=$e)},setFunc:function($e,Qt,ln){(ie!==$e||_e!==Qt||ee!==ln)&&(i.stencilFunc($e,Qt,ln),ie=$e,_e=Qt,ee=ln)},setOp:function($e,Qt,ln){(Z!==$e||oe!==Qt||Le!==ln)&&(i.stencilOp($e,Qt,ln),Z=$e,oe=Qt,Le=ln)},setLocked:function($e){D=$e},setClear:function($e){it!==$e&&(i.clearStencil($e),it=$e)},reset:function(){D=!1,pe=null,ie=null,_e=null,ee=null,Z=null,oe=null,Le=null,it=null}}}const r=new t,o=new n,a=new s,l=new WeakMap,c=new WeakMap;let h={},d={},u=new WeakMap,f=[],g=null,x=!1,m=null,p=null,S=null,T=null,E=null,A=null,R=null,C=new ze(0,0,0),N=0,v=!1,y=null,P=null,z=null,U=null,V=null;const G=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let k=!1,H=0;const J=i.getParameter(i.VERSION);J.indexOf("WebGL")!==-1?(H=parseFloat(/^WebGL (\d)/.exec(J)[1]),k=H>=1):J.indexOf("OpenGL ES")!==-1&&(H=parseFloat(/^OpenGL ES (\d)/.exec(J)[1]),k=H>=2);let ae=null,se={};const j=i.getParameter(i.SCISSOR_BOX),Se=i.getParameter(i.VIEWPORT),ge=new ut().fromArray(j),Ue=new ut().fromArray(Se);function O(D,pe,ie,_e){const ee=new Uint8Array(4),Z=i.createTexture();i.bindTexture(D,Z),i.texParameteri(D,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(D,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let oe=0;oe<ie;oe++)D===i.TEXTURE_3D||D===i.TEXTURE_2D_ARRAY?i.texImage3D(pe,0,i.RGBA,1,1,_e,0,i.RGBA,i.UNSIGNED_BYTE,ee):i.texImage2D(pe+oe,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ee);return Z}const W={};W[i.TEXTURE_2D]=O(i.TEXTURE_2D,i.TEXTURE_2D,1),W[i.TEXTURE_CUBE_MAP]=O(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),W[i.TEXTURE_2D_ARRAY]=O(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),W[i.TEXTURE_3D]=O(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),Y(i.DEPTH_TEST),o.setFunc(gi),Be(!1),ft(ca),Y(i.CULL_FACE),je(_n);function Y(D){h[D]!==!0&&(i.enable(D),h[D]=!0)}function ne(D){h[D]!==!1&&(i.disable(D),h[D]=!1)}function re(D,pe){return d[D]!==pe?(i.bindFramebuffer(D,pe),d[D]=pe,D===i.DRAW_FRAMEBUFFER&&(d[i.FRAMEBUFFER]=pe),D===i.FRAMEBUFFER&&(d[i.DRAW_FRAMEBUFFER]=pe),!0):!1}function me(D,pe){let ie=f,_e=!1;if(D){ie=u.get(pe),ie===void 0&&(ie=[],u.set(pe,ie));const ee=D.textures;if(ie.length!==ee.length||ie[0]!==i.COLOR_ATTACHMENT0){for(let Z=0,oe=ee.length;Z<oe;Z++)ie[Z]=i.COLOR_ATTACHMENT0+Z;ie.length=ee.length,_e=!0}}else ie[0]!==i.BACK&&(ie[0]=i.BACK,_e=!0);_e&&i.drawBuffers(ie)}function Ne(D){return g!==D?(i.useProgram(D),g=D,!0):!1}const ot={[Bn]:i.FUNC_ADD,[$l]:i.FUNC_SUBTRACT,[Kl]:i.FUNC_REVERSE_SUBTRACT};ot[Zl]=i.MIN,ot[Jl]=i.MAX;const He={[Ql]:i.ZERO,[eh]:i.ONE,[th]:i.SRC_COLOR,[Dr]:i.SRC_ALPHA,[ah]:i.SRC_ALPHA_SATURATE,[rh]:i.DST_COLOR,[ih]:i.DST_ALPHA,[nh]:i.ONE_MINUS_SRC_COLOR,[Lr]:i.ONE_MINUS_SRC_ALPHA,[oh]:i.ONE_MINUS_DST_COLOR,[sh]:i.ONE_MINUS_DST_ALPHA,[ch]:i.CONSTANT_COLOR,[lh]:i.ONE_MINUS_CONSTANT_COLOR,[hh]:i.CONSTANT_ALPHA,[dh]:i.ONE_MINUS_CONSTANT_ALPHA};function je(D,pe,ie,_e,ee,Z,oe,Le,it,$e){if(D===_n){x===!0&&(ne(i.BLEND),x=!1);return}if(x===!1&&(Y(i.BLEND),x=!0),D!==jl){if(D!==m||$e!==v){if((p!==Bn||E!==Bn)&&(i.blendEquation(i.FUNC_ADD),p=Bn,E=Bn),$e)switch(D){case fi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case la:i.blendFunc(i.ONE,i.ONE);break;case ha:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case da:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:We("WebGLState: Invalid blending: ",D);break}else switch(D){case fi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case la:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case ha:We("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case da:We("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:We("WebGLState: Invalid blending: ",D);break}S=null,T=null,A=null,R=null,C.set(0,0,0),N=0,m=D,v=$e}return}ee=ee||pe,Z=Z||ie,oe=oe||_e,(pe!==p||ee!==E)&&(i.blendEquationSeparate(ot[pe],ot[ee]),p=pe,E=ee),(ie!==S||_e!==T||Z!==A||oe!==R)&&(i.blendFuncSeparate(He[ie],He[_e],He[Z],He[oe]),S=ie,T=_e,A=Z,R=oe),(Le.equals(C)===!1||it!==N)&&(i.blendColor(Le.r,Le.g,Le.b,it),C.copy(Le),N=it),m=D,v=!1}function et(D,pe){D.side===qt?ne(i.CULL_FACE):Y(i.CULL_FACE);let ie=D.side===Ct;pe&&(ie=!ie),Be(ie),D.blending===fi&&D.transparent===!1?je(_n):je(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),o.setFunc(D.depthFunc),o.setTest(D.depthTest),o.setMask(D.depthWrite),r.setMask(D.colorWrite);const _e=D.stencilWrite;a.setTest(_e),_e&&(a.setMask(D.stencilWriteMask),a.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),a.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),pt(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?Y(i.SAMPLE_ALPHA_TO_COVERAGE):ne(i.SAMPLE_ALPHA_TO_COVERAGE)}function Be(D){y!==D&&(D?i.frontFace(i.CW):i.frontFace(i.CCW),y=D)}function ft(D){D!==Xl?(Y(i.CULL_FACE),D!==P&&(D===ca?i.cullFace(i.BACK):D===ql?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):ne(i.CULL_FACE),P=D}function I(D){D!==z&&(k&&i.lineWidth(D),z=D)}function pt(D,pe,ie){D?(Y(i.POLYGON_OFFSET_FILL),(U!==pe||V!==ie)&&(i.polygonOffset(pe,ie),U=pe,V=ie)):ne(i.POLYGON_OFFSET_FILL)}function Ye(D){D?Y(i.SCISSOR_TEST):ne(i.SCISSOR_TEST)}function nt(D){D===void 0&&(D=i.TEXTURE0+G-1),ae!==D&&(i.activeTexture(D),ae=D)}function be(D,pe,ie){ie===void 0&&(ae===null?ie=i.TEXTURE0+G-1:ie=ae);let _e=se[ie];_e===void 0&&(_e={type:void 0,texture:void 0},se[ie]=_e),(_e.type!==D||_e.texture!==pe)&&(ae!==ie&&(i.activeTexture(ie),ae=ie),i.bindTexture(D,pe||W[D]),_e.type=D,_e.texture=pe)}function b(){const D=se[ae];D!==void 0&&D.type!==void 0&&(i.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function _(){try{i.compressedTexImage2D(...arguments)}catch(D){We("WebGLState:",D)}}function L(){try{i.compressedTexImage3D(...arguments)}catch(D){We("WebGLState:",D)}}function K(){try{i.texSubImage2D(...arguments)}catch(D){We("WebGLState:",D)}}function Q(){try{i.texSubImage3D(...arguments)}catch(D){We("WebGLState:",D)}}function $(){try{i.compressedTexSubImage2D(...arguments)}catch(D){We("WebGLState:",D)}}function Te(){try{i.compressedTexSubImage3D(...arguments)}catch(D){We("WebGLState:",D)}}function ce(){try{i.texStorage2D(...arguments)}catch(D){We("WebGLState:",D)}}function ye(){try{i.texStorage3D(...arguments)}catch(D){We("WebGLState:",D)}}function Ie(){try{i.texImage2D(...arguments)}catch(D){We("WebGLState:",D)}}function te(){try{i.texImage3D(...arguments)}catch(D){We("WebGLState:",D)}}function he(D){ge.equals(D)===!1&&(i.scissor(D.x,D.y,D.z,D.w),ge.copy(D))}function Me(D){Ue.equals(D)===!1&&(i.viewport(D.x,D.y,D.z,D.w),Ue.copy(D))}function Ee(D,pe){let ie=c.get(pe);ie===void 0&&(ie=new WeakMap,c.set(pe,ie));let _e=ie.get(D);_e===void 0&&(_e=i.getUniformBlockIndex(pe,D.name),ie.set(D,_e))}function le(D,pe){const _e=c.get(pe).get(D);l.get(pe)!==_e&&(i.uniformBlockBinding(pe,_e,D.__bindingPointIndex),l.set(pe,_e))}function Ve(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},ae=null,se={},d={},u=new WeakMap,f=[],g=null,x=!1,m=null,p=null,S=null,T=null,E=null,A=null,R=null,C=new ze(0,0,0),N=0,v=!1,y=null,P=null,z=null,U=null,V=null,ge.set(0,0,i.canvas.width,i.canvas.height),Ue.set(0,0,i.canvas.width,i.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:Y,disable:ne,bindFramebuffer:re,drawBuffers:me,useProgram:Ne,setBlending:je,setMaterial:et,setFlipSided:Be,setCullFace:ft,setLineWidth:I,setPolygonOffset:pt,setScissorTest:Ye,activeTexture:nt,bindTexture:be,unbindTexture:b,compressedTexImage2D:_,compressedTexImage3D:L,texImage2D:Ie,texImage3D:te,updateUBOMapping:Ee,uniformBlockBinding:le,texStorage2D:ce,texStorage3D:ye,texSubImage2D:K,texSubImage3D:Q,compressedTexSubImage2D:$,compressedTexSubImage3D:Te,scissor:he,viewport:Me,reset:Ve}}function Zm(i,e,t,n,s,r,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ce,h=new WeakMap;let d;const u=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(b,_){return f?new OffscreenCanvas(b,_):zs("canvas")}function x(b,_,L){let K=1;const Q=be(b);if((Q.width>L||Q.height>L)&&(K=L/Math.max(Q.width,Q.height)),K<1)if(typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&b instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&b instanceof ImageBitmap||typeof VideoFrame<"u"&&b instanceof VideoFrame){const $=Math.floor(K*Q.width),Te=Math.floor(K*Q.height);d===void 0&&(d=g($,Te));const ce=_?g($,Te):d;return ce.width=$,ce.height=Te,ce.getContext("2d").drawImage(b,0,0,$,Te),De("WebGLRenderer: Texture has been resized from ("+Q.width+"x"+Q.height+") to ("+$+"x"+Te+")."),ce}else return"data"in b&&De("WebGLRenderer: Image in DataTexture is too big ("+Q.width+"x"+Q.height+")."),b;return b}function m(b){return b.generateMipmaps}function p(b){i.generateMipmap(b)}function S(b){return b.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:b.isWebGL3DRenderTarget?i.TEXTURE_3D:b.isWebGLArrayRenderTarget||b.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function T(b,_,L,K,Q=!1){if(b!==null){if(i[b]!==void 0)return i[b];De("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+b+"'")}let $=_;if(_===i.RED&&(L===i.FLOAT&&($=i.R32F),L===i.HALF_FLOAT&&($=i.R16F),L===i.UNSIGNED_BYTE&&($=i.R8)),_===i.RED_INTEGER&&(L===i.UNSIGNED_BYTE&&($=i.R8UI),L===i.UNSIGNED_SHORT&&($=i.R16UI),L===i.UNSIGNED_INT&&($=i.R32UI),L===i.BYTE&&($=i.R8I),L===i.SHORT&&($=i.R16I),L===i.INT&&($=i.R32I)),_===i.RG&&(L===i.FLOAT&&($=i.RG32F),L===i.HALF_FLOAT&&($=i.RG16F),L===i.UNSIGNED_BYTE&&($=i.RG8)),_===i.RG_INTEGER&&(L===i.UNSIGNED_BYTE&&($=i.RG8UI),L===i.UNSIGNED_SHORT&&($=i.RG16UI),L===i.UNSIGNED_INT&&($=i.RG32UI),L===i.BYTE&&($=i.RG8I),L===i.SHORT&&($=i.RG16I),L===i.INT&&($=i.RG32I)),_===i.RGB_INTEGER&&(L===i.UNSIGNED_BYTE&&($=i.RGB8UI),L===i.UNSIGNED_SHORT&&($=i.RGB16UI),L===i.UNSIGNED_INT&&($=i.RGB32UI),L===i.BYTE&&($=i.RGB8I),L===i.SHORT&&($=i.RGB16I),L===i.INT&&($=i.RGB32I)),_===i.RGBA_INTEGER&&(L===i.UNSIGNED_BYTE&&($=i.RGBA8UI),L===i.UNSIGNED_SHORT&&($=i.RGBA16UI),L===i.UNSIGNED_INT&&($=i.RGBA32UI),L===i.BYTE&&($=i.RGBA8I),L===i.SHORT&&($=i.RGBA16I),L===i.INT&&($=i.RGBA32I)),_===i.RGB&&(L===i.UNSIGNED_INT_5_9_9_9_REV&&($=i.RGB9_E5),L===i.UNSIGNED_INT_10F_11F_11F_REV&&($=i.R11F_G11F_B10F)),_===i.RGBA){const Te=Q?Ns:Xe.getTransfer(K);L===i.FLOAT&&($=i.RGBA32F),L===i.HALF_FLOAT&&($=i.RGBA16F),L===i.UNSIGNED_BYTE&&($=Te===Ze?i.SRGB8_ALPHA8:i.RGBA8),L===i.UNSIGNED_SHORT_4_4_4_4&&($=i.RGBA4),L===i.UNSIGNED_SHORT_5_5_5_1&&($=i.RGB5_A1)}return($===i.R16F||$===i.R32F||$===i.RG16F||$===i.RG32F||$===i.RGBA16F||$===i.RGBA32F)&&e.get("EXT_color_buffer_float"),$}function E(b,_){let L;return b?_===null||_===an||_===Vi?L=i.DEPTH24_STENCIL8:_===nn?L=i.DEPTH32F_STENCIL8:_===Bi&&(L=i.DEPTH24_STENCIL8,De("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===an||_===Vi?L=i.DEPTH_COMPONENT24:_===nn?L=i.DEPTH_COMPONENT32F:_===Bi&&(L=i.DEPTH_COMPONENT16),L}function A(b,_){return m(b)===!0||b.isFramebufferTexture&&b.minFilter!==yt&&b.minFilter!==At?Math.log2(Math.max(_.width,_.height))+1:b.mipmaps!==void 0&&b.mipmaps.length>0?b.mipmaps.length:b.isCompressedTexture&&Array.isArray(b.image)?_.mipmaps.length:1}function R(b){const _=b.target;_.removeEventListener("dispose",R),N(_),_.isVideoTexture&&h.delete(_)}function C(b){const _=b.target;_.removeEventListener("dispose",C),y(_)}function N(b){const _=n.get(b);if(_.__webglInit===void 0)return;const L=b.source,K=u.get(L);if(K){const Q=K[_.__cacheKey];Q.usedTimes--,Q.usedTimes===0&&v(b),Object.keys(K).length===0&&u.delete(L)}n.remove(b)}function v(b){const _=n.get(b);i.deleteTexture(_.__webglTexture);const L=b.source,K=u.get(L);delete K[_.__cacheKey],o.memory.textures--}function y(b){const _=n.get(b);if(b.depthTexture&&(b.depthTexture.dispose(),n.remove(b.depthTexture)),b.isWebGLCubeRenderTarget)for(let K=0;K<6;K++){if(Array.isArray(_.__webglFramebuffer[K]))for(let Q=0;Q<_.__webglFramebuffer[K].length;Q++)i.deleteFramebuffer(_.__webglFramebuffer[K][Q]);else i.deleteFramebuffer(_.__webglFramebuffer[K]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[K])}else{if(Array.isArray(_.__webglFramebuffer))for(let K=0;K<_.__webglFramebuffer.length;K++)i.deleteFramebuffer(_.__webglFramebuffer[K]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let K=0;K<_.__webglColorRenderbuffer.length;K++)_.__webglColorRenderbuffer[K]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[K]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const L=b.textures;for(let K=0,Q=L.length;K<Q;K++){const $=n.get(L[K]);$.__webglTexture&&(i.deleteTexture($.__webglTexture),o.memory.textures--),n.remove(L[K])}n.remove(b)}let P=0;function z(){P=0}function U(){const b=P;return b>=s.maxTextures&&De("WebGLTextures: Trying to use "+b+" texture units while this GPU supports only "+s.maxTextures),P+=1,b}function V(b){const _=[];return _.push(b.wrapS),_.push(b.wrapT),_.push(b.wrapR||0),_.push(b.magFilter),_.push(b.minFilter),_.push(b.anisotropy),_.push(b.internalFormat),_.push(b.format),_.push(b.type),_.push(b.generateMipmaps),_.push(b.premultiplyAlpha),_.push(b.flipY),_.push(b.unpackAlignment),_.push(b.colorSpace),_.join()}function G(b,_){const L=n.get(b);if(b.isVideoTexture&&Ye(b),b.isRenderTargetTexture===!1&&b.isExternalTexture!==!0&&b.version>0&&L.__version!==b.version){const K=b.image;if(K===null)De("WebGLRenderer: Texture marked for update but no image data found.");else if(K.complete===!1)De("WebGLRenderer: Texture marked for update but image is incomplete");else{W(L,b,_);return}}else b.isExternalTexture&&(L.__webglTexture=b.sourceTexture?b.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,L.__webglTexture,i.TEXTURE0+_)}function k(b,_){const L=n.get(b);if(b.isRenderTargetTexture===!1&&b.version>0&&L.__version!==b.version){W(L,b,_);return}else b.isExternalTexture&&(L.__webglTexture=b.sourceTexture?b.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,L.__webglTexture,i.TEXTURE0+_)}function H(b,_){const L=n.get(b);if(b.isRenderTargetTexture===!1&&b.version>0&&L.__version!==b.version){W(L,b,_);return}t.bindTexture(i.TEXTURE_3D,L.__webglTexture,i.TEXTURE0+_)}function J(b,_){const L=n.get(b);if(b.isCubeDepthTexture!==!0&&b.version>0&&L.__version!==b.version){Y(L,b,_);return}t.bindTexture(i.TEXTURE_CUBE_MAP,L.__webglTexture,i.TEXTURE0+_)}const ae={[Hr]:i.REPEAT,[gn]:i.CLAMP_TO_EDGE,[Wr]:i.MIRRORED_REPEAT},se={[yt]:i.NEAREST,[ph]:i.NEAREST_MIPMAP_NEAREST,[Qi]:i.NEAREST_MIPMAP_LINEAR,[At]:i.LINEAR,[Zs]:i.LINEAR_MIPMAP_NEAREST,[Gn]:i.LINEAR_MIPMAP_LINEAR},j={[_h]:i.NEVER,[Sh]:i.ALWAYS,[xh]:i.LESS,[Vo]:i.LEQUAL,[vh]:i.EQUAL,[ko]:i.GEQUAL,[Mh]:i.GREATER,[yh]:i.NOTEQUAL};function Se(b,_){if(_.type===nn&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===At||_.magFilter===Zs||_.magFilter===Qi||_.magFilter===Gn||_.minFilter===At||_.minFilter===Zs||_.minFilter===Qi||_.minFilter===Gn)&&De("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(b,i.TEXTURE_WRAP_S,ae[_.wrapS]),i.texParameteri(b,i.TEXTURE_WRAP_T,ae[_.wrapT]),(b===i.TEXTURE_3D||b===i.TEXTURE_2D_ARRAY)&&i.texParameteri(b,i.TEXTURE_WRAP_R,ae[_.wrapR]),i.texParameteri(b,i.TEXTURE_MAG_FILTER,se[_.magFilter]),i.texParameteri(b,i.TEXTURE_MIN_FILTER,se[_.minFilter]),_.compareFunction&&(i.texParameteri(b,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(b,i.TEXTURE_COMPARE_FUNC,j[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===yt||_.minFilter!==Qi&&_.minFilter!==Gn||_.type===nn&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const L=e.get("EXT_texture_filter_anisotropic");i.texParameterf(b,L.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,s.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function ge(b,_){let L=!1;b.__webglInit===void 0&&(b.__webglInit=!0,_.addEventListener("dispose",R));const K=_.source;let Q=u.get(K);Q===void 0&&(Q={},u.set(K,Q));const $=V(_);if($!==b.__cacheKey){Q[$]===void 0&&(Q[$]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,L=!0),Q[$].usedTimes++;const Te=Q[b.__cacheKey];Te!==void 0&&(Q[b.__cacheKey].usedTimes--,Te.usedTimes===0&&v(_)),b.__cacheKey=$,b.__webglTexture=Q[$].texture}return L}function Ue(b,_,L){return Math.floor(Math.floor(b/L)/_)}function O(b,_,L,K){const $=b.updateRanges;if($.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,_.width,_.height,L,K,_.data);else{$.sort((te,he)=>te.start-he.start);let Te=0;for(let te=1;te<$.length;te++){const he=$[Te],Me=$[te],Ee=he.start+he.count,le=Ue(Me.start,_.width,4),Ve=Ue(he.start,_.width,4);Me.start<=Ee+1&&le===Ve&&Ue(Me.start+Me.count-1,_.width,4)===le?he.count=Math.max(he.count,Me.start+Me.count-he.start):(++Te,$[Te]=Me)}$.length=Te+1;const ce=i.getParameter(i.UNPACK_ROW_LENGTH),ye=i.getParameter(i.UNPACK_SKIP_PIXELS),Ie=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,_.width);for(let te=0,he=$.length;te<he;te++){const Me=$[te],Ee=Math.floor(Me.start/4),le=Math.ceil(Me.count/4),Ve=Ee%_.width,D=Math.floor(Ee/_.width),pe=le,ie=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,Ve),i.pixelStorei(i.UNPACK_SKIP_ROWS,D),t.texSubImage2D(i.TEXTURE_2D,0,Ve,D,pe,ie,L,K,_.data)}b.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,ce),i.pixelStorei(i.UNPACK_SKIP_PIXELS,ye),i.pixelStorei(i.UNPACK_SKIP_ROWS,Ie)}}function W(b,_,L){let K=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(K=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(K=i.TEXTURE_3D);const Q=ge(b,_),$=_.source;t.bindTexture(K,b.__webglTexture,i.TEXTURE0+L);const Te=n.get($);if($.version!==Te.__version||Q===!0){t.activeTexture(i.TEXTURE0+L);const ce=Xe.getPrimaries(Xe.workingColorSpace),ye=_.colorSpace===Rn?null:Xe.getPrimaries(_.colorSpace),Ie=_.colorSpace===Rn||ce===ye?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ie);let te=x(_.image,!1,s.maxTextureSize);te=nt(_,te);const he=r.convert(_.format,_.colorSpace),Me=r.convert(_.type);let Ee=T(_.internalFormat,he,Me,_.colorSpace,_.isVideoTexture);Se(K,_);let le;const Ve=_.mipmaps,D=_.isVideoTexture!==!0,pe=Te.__version===void 0||Q===!0,ie=$.dataReady,_e=A(_,te);if(_.isDepthTexture)Ee=E(_.format===Hn,_.type),pe&&(D?t.texStorage2D(i.TEXTURE_2D,1,Ee,te.width,te.height):t.texImage2D(i.TEXTURE_2D,0,Ee,te.width,te.height,0,he,Me,null));else if(_.isDataTexture)if(Ve.length>0){D&&pe&&t.texStorage2D(i.TEXTURE_2D,_e,Ee,Ve[0].width,Ve[0].height);for(let ee=0,Z=Ve.length;ee<Z;ee++)le=Ve[ee],D?ie&&t.texSubImage2D(i.TEXTURE_2D,ee,0,0,le.width,le.height,he,Me,le.data):t.texImage2D(i.TEXTURE_2D,ee,Ee,le.width,le.height,0,he,Me,le.data);_.generateMipmaps=!1}else D?(pe&&t.texStorage2D(i.TEXTURE_2D,_e,Ee,te.width,te.height),ie&&O(_,te,he,Me)):t.texImage2D(i.TEXTURE_2D,0,Ee,te.width,te.height,0,he,Me,te.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){D&&pe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,_e,Ee,Ve[0].width,Ve[0].height,te.depth);for(let ee=0,Z=Ve.length;ee<Z;ee++)if(le=Ve[ee],_.format!==Jt)if(he!==null)if(D){if(ie)if(_.layerUpdates.size>0){const oe=Ga(le.width,le.height,_.format,_.type);for(const Le of _.layerUpdates){const it=le.data.subarray(Le*oe/le.data.BYTES_PER_ELEMENT,(Le+1)*oe/le.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ee,0,0,Le,le.width,le.height,1,he,it)}_.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ee,0,0,0,le.width,le.height,te.depth,he,le.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,ee,Ee,le.width,le.height,te.depth,0,le.data,0,0);else De("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else D?ie&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,ee,0,0,0,le.width,le.height,te.depth,he,Me,le.data):t.texImage3D(i.TEXTURE_2D_ARRAY,ee,Ee,le.width,le.height,te.depth,0,he,Me,le.data)}else{D&&pe&&t.texStorage2D(i.TEXTURE_2D,_e,Ee,Ve[0].width,Ve[0].height);for(let ee=0,Z=Ve.length;ee<Z;ee++)le=Ve[ee],_.format!==Jt?he!==null?D?ie&&t.compressedTexSubImage2D(i.TEXTURE_2D,ee,0,0,le.width,le.height,he,le.data):t.compressedTexImage2D(i.TEXTURE_2D,ee,Ee,le.width,le.height,0,le.data):De("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):D?ie&&t.texSubImage2D(i.TEXTURE_2D,ee,0,0,le.width,le.height,he,Me,le.data):t.texImage2D(i.TEXTURE_2D,ee,Ee,le.width,le.height,0,he,Me,le.data)}else if(_.isDataArrayTexture)if(D){if(pe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,_e,Ee,te.width,te.height,te.depth),ie)if(_.layerUpdates.size>0){const ee=Ga(te.width,te.height,_.format,_.type);for(const Z of _.layerUpdates){const oe=te.data.subarray(Z*ee/te.data.BYTES_PER_ELEMENT,(Z+1)*ee/te.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,Z,te.width,te.height,1,he,Me,oe)}_.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,te.width,te.height,te.depth,he,Me,te.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Ee,te.width,te.height,te.depth,0,he,Me,te.data);else if(_.isData3DTexture)D?(pe&&t.texStorage3D(i.TEXTURE_3D,_e,Ee,te.width,te.height,te.depth),ie&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,te.width,te.height,te.depth,he,Me,te.data)):t.texImage3D(i.TEXTURE_3D,0,Ee,te.width,te.height,te.depth,0,he,Me,te.data);else if(_.isFramebufferTexture){if(pe)if(D)t.texStorage2D(i.TEXTURE_2D,_e,Ee,te.width,te.height);else{let ee=te.width,Z=te.height;for(let oe=0;oe<_e;oe++)t.texImage2D(i.TEXTURE_2D,oe,Ee,ee,Z,0,he,Me,null),ee>>=1,Z>>=1}}else if(Ve.length>0){if(D&&pe){const ee=be(Ve[0]);t.texStorage2D(i.TEXTURE_2D,_e,Ee,ee.width,ee.height)}for(let ee=0,Z=Ve.length;ee<Z;ee++)le=Ve[ee],D?ie&&t.texSubImage2D(i.TEXTURE_2D,ee,0,0,he,Me,le):t.texImage2D(i.TEXTURE_2D,ee,Ee,he,Me,le);_.generateMipmaps=!1}else if(D){if(pe){const ee=be(te);t.texStorage2D(i.TEXTURE_2D,_e,Ee,ee.width,ee.height)}ie&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,he,Me,te)}else t.texImage2D(i.TEXTURE_2D,0,Ee,he,Me,te);m(_)&&p(K),Te.__version=$.version,_.onUpdate&&_.onUpdate(_)}b.__version=_.version}function Y(b,_,L){if(_.image.length!==6)return;const K=ge(b,_),Q=_.source;t.bindTexture(i.TEXTURE_CUBE_MAP,b.__webglTexture,i.TEXTURE0+L);const $=n.get(Q);if(Q.version!==$.__version||K===!0){t.activeTexture(i.TEXTURE0+L);const Te=Xe.getPrimaries(Xe.workingColorSpace),ce=_.colorSpace===Rn?null:Xe.getPrimaries(_.colorSpace),ye=_.colorSpace===Rn||Te===ce?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ye);const Ie=_.isCompressedTexture||_.image[0].isCompressedTexture,te=_.image[0]&&_.image[0].isDataTexture,he=[];for(let Z=0;Z<6;Z++)!Ie&&!te?he[Z]=x(_.image[Z],!0,s.maxCubemapSize):he[Z]=te?_.image[Z].image:_.image[Z],he[Z]=nt(_,he[Z]);const Me=he[0],Ee=r.convert(_.format,_.colorSpace),le=r.convert(_.type),Ve=T(_.internalFormat,Ee,le,_.colorSpace),D=_.isVideoTexture!==!0,pe=$.__version===void 0||K===!0,ie=Q.dataReady;let _e=A(_,Me);Se(i.TEXTURE_CUBE_MAP,_);let ee;if(Ie){D&&pe&&t.texStorage2D(i.TEXTURE_CUBE_MAP,_e,Ve,Me.width,Me.height);for(let Z=0;Z<6;Z++){ee=he[Z].mipmaps;for(let oe=0;oe<ee.length;oe++){const Le=ee[oe];_.format!==Jt?Ee!==null?D?ie&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,oe,0,0,Le.width,Le.height,Ee,Le.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,oe,Ve,Le.width,Le.height,0,Le.data):De("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):D?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,oe,0,0,Le.width,Le.height,Ee,le,Le.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,oe,Ve,Le.width,Le.height,0,Ee,le,Le.data)}}}else{if(ee=_.mipmaps,D&&pe){ee.length>0&&_e++;const Z=be(he[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,_e,Ve,Z.width,Z.height)}for(let Z=0;Z<6;Z++)if(te){D?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,he[Z].width,he[Z].height,Ee,le,he[Z].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,Ve,he[Z].width,he[Z].height,0,Ee,le,he[Z].data);for(let oe=0;oe<ee.length;oe++){const it=ee[oe].image[Z].image;D?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,oe+1,0,0,it.width,it.height,Ee,le,it.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,oe+1,Ve,it.width,it.height,0,Ee,le,it.data)}}else{D?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,Ee,le,he[Z]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,Ve,Ee,le,he[Z]);for(let oe=0;oe<ee.length;oe++){const Le=ee[oe];D?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,oe+1,0,0,Ee,le,Le.image[Z]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,oe+1,Ve,Ee,le,Le.image[Z])}}}m(_)&&p(i.TEXTURE_CUBE_MAP),$.__version=Q.version,_.onUpdate&&_.onUpdate(_)}b.__version=_.version}function ne(b,_,L,K,Q,$){const Te=r.convert(L.format,L.colorSpace),ce=r.convert(L.type),ye=T(L.internalFormat,Te,ce,L.colorSpace),Ie=n.get(_),te=n.get(L);if(te.__renderTarget=_,!Ie.__hasExternalTextures){const he=Math.max(1,_.width>>$),Me=Math.max(1,_.height>>$);Q===i.TEXTURE_3D||Q===i.TEXTURE_2D_ARRAY?t.texImage3D(Q,$,ye,he,Me,_.depth,0,Te,ce,null):t.texImage2D(Q,$,ye,he,Me,0,Te,ce,null)}t.bindFramebuffer(i.FRAMEBUFFER,b),pt(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,K,Q,te.__webglTexture,0,I(_)):(Q===i.TEXTURE_2D||Q>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Q<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,K,Q,te.__webglTexture,$),t.bindFramebuffer(i.FRAMEBUFFER,null)}function re(b,_,L){if(i.bindRenderbuffer(i.RENDERBUFFER,b),_.depthBuffer){const K=_.depthTexture,Q=K&&K.isDepthTexture?K.type:null,$=E(_.stencilBuffer,Q),Te=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;pt(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,I(_),$,_.width,_.height):L?i.renderbufferStorageMultisample(i.RENDERBUFFER,I(_),$,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,$,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Te,i.RENDERBUFFER,b)}else{const K=_.textures;for(let Q=0;Q<K.length;Q++){const $=K[Q],Te=r.convert($.format,$.colorSpace),ce=r.convert($.type),ye=T($.internalFormat,Te,ce,$.colorSpace);pt(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,I(_),ye,_.width,_.height):L?i.renderbufferStorageMultisample(i.RENDERBUFFER,I(_),ye,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,ye,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function me(b,_,L){const K=_.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,b),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Q=n.get(_.depthTexture);if(Q.__renderTarget=_,(!Q.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),K){if(Q.__webglInit===void 0&&(Q.__webglInit=!0,_.depthTexture.addEventListener("dispose",R)),Q.__webglTexture===void 0){Q.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,Q.__webglTexture),Se(i.TEXTURE_CUBE_MAP,_.depthTexture);const Ie=r.convert(_.depthTexture.format),te=r.convert(_.depthTexture.type);let he;_.depthTexture.format===Mn?he=i.DEPTH_COMPONENT24:_.depthTexture.format===Hn&&(he=i.DEPTH24_STENCIL8);for(let Me=0;Me<6;Me++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Me,0,he,_.width,_.height,0,Ie,te,null)}}else G(_.depthTexture,0);const $=Q.__webglTexture,Te=I(_),ce=K?i.TEXTURE_CUBE_MAP_POSITIVE_X+L:i.TEXTURE_2D,ye=_.depthTexture.format===Hn?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(_.depthTexture.format===Mn)pt(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,ye,ce,$,0,Te):i.framebufferTexture2D(i.FRAMEBUFFER,ye,ce,$,0);else if(_.depthTexture.format===Hn)pt(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,ye,ce,$,0,Te):i.framebufferTexture2D(i.FRAMEBUFFER,ye,ce,$,0);else throw new Error("Unknown depthTexture format")}function Ne(b){const _=n.get(b),L=b.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==b.depthTexture){const K=b.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),K){const Q=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,K.removeEventListener("dispose",Q)};K.addEventListener("dispose",Q),_.__depthDisposeCallback=Q}_.__boundDepthTexture=K}if(b.depthTexture&&!_.__autoAllocateDepthBuffer)if(L)for(let K=0;K<6;K++)me(_.__webglFramebuffer[K],b,K);else{const K=b.texture.mipmaps;K&&K.length>0?me(_.__webglFramebuffer[0],b,0):me(_.__webglFramebuffer,b,0)}else if(L){_.__webglDepthbuffer=[];for(let K=0;K<6;K++)if(t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[K]),_.__webglDepthbuffer[K]===void 0)_.__webglDepthbuffer[K]=i.createRenderbuffer(),re(_.__webglDepthbuffer[K],b,!1);else{const Q=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,$=_.__webglDepthbuffer[K];i.bindRenderbuffer(i.RENDERBUFFER,$),i.framebufferRenderbuffer(i.FRAMEBUFFER,Q,i.RENDERBUFFER,$)}}else{const K=b.texture.mipmaps;if(K&&K.length>0?t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),re(_.__webglDepthbuffer,b,!1);else{const Q=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,$=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,$),i.framebufferRenderbuffer(i.FRAMEBUFFER,Q,i.RENDERBUFFER,$)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function ot(b,_,L){const K=n.get(b);_!==void 0&&ne(K.__webglFramebuffer,b,b.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),L!==void 0&&Ne(b)}function He(b){const _=b.texture,L=n.get(b),K=n.get(_);b.addEventListener("dispose",C);const Q=b.textures,$=b.isWebGLCubeRenderTarget===!0,Te=Q.length>1;if(Te||(K.__webglTexture===void 0&&(K.__webglTexture=i.createTexture()),K.__version=_.version,o.memory.textures++),$){L.__webglFramebuffer=[];for(let ce=0;ce<6;ce++)if(_.mipmaps&&_.mipmaps.length>0){L.__webglFramebuffer[ce]=[];for(let ye=0;ye<_.mipmaps.length;ye++)L.__webglFramebuffer[ce][ye]=i.createFramebuffer()}else L.__webglFramebuffer[ce]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){L.__webglFramebuffer=[];for(let ce=0;ce<_.mipmaps.length;ce++)L.__webglFramebuffer[ce]=i.createFramebuffer()}else L.__webglFramebuffer=i.createFramebuffer();if(Te)for(let ce=0,ye=Q.length;ce<ye;ce++){const Ie=n.get(Q[ce]);Ie.__webglTexture===void 0&&(Ie.__webglTexture=i.createTexture(),o.memory.textures++)}if(b.samples>0&&pt(b)===!1){L.__webglMultisampledFramebuffer=i.createFramebuffer(),L.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,L.__webglMultisampledFramebuffer);for(let ce=0;ce<Q.length;ce++){const ye=Q[ce];L.__webglColorRenderbuffer[ce]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,L.__webglColorRenderbuffer[ce]);const Ie=r.convert(ye.format,ye.colorSpace),te=r.convert(ye.type),he=T(ye.internalFormat,Ie,te,ye.colorSpace,b.isXRRenderTarget===!0),Me=I(b);i.renderbufferStorageMultisample(i.RENDERBUFFER,Me,he,b.width,b.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ce,i.RENDERBUFFER,L.__webglColorRenderbuffer[ce])}i.bindRenderbuffer(i.RENDERBUFFER,null),b.depthBuffer&&(L.__webglDepthRenderbuffer=i.createRenderbuffer(),re(L.__webglDepthRenderbuffer,b,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if($){t.bindTexture(i.TEXTURE_CUBE_MAP,K.__webglTexture),Se(i.TEXTURE_CUBE_MAP,_);for(let ce=0;ce<6;ce++)if(_.mipmaps&&_.mipmaps.length>0)for(let ye=0;ye<_.mipmaps.length;ye++)ne(L.__webglFramebuffer[ce][ye],b,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,ye);else ne(L.__webglFramebuffer[ce],b,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0);m(_)&&p(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Te){for(let ce=0,ye=Q.length;ce<ye;ce++){const Ie=Q[ce],te=n.get(Ie);let he=i.TEXTURE_2D;(b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(he=b.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(he,te.__webglTexture),Se(he,Ie),ne(L.__webglFramebuffer,b,Ie,i.COLOR_ATTACHMENT0+ce,he,0),m(Ie)&&p(he)}t.unbindTexture()}else{let ce=i.TEXTURE_2D;if((b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(ce=b.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ce,K.__webglTexture),Se(ce,_),_.mipmaps&&_.mipmaps.length>0)for(let ye=0;ye<_.mipmaps.length;ye++)ne(L.__webglFramebuffer[ye],b,_,i.COLOR_ATTACHMENT0,ce,ye);else ne(L.__webglFramebuffer,b,_,i.COLOR_ATTACHMENT0,ce,0);m(_)&&p(ce),t.unbindTexture()}b.depthBuffer&&Ne(b)}function je(b){const _=b.textures;for(let L=0,K=_.length;L<K;L++){const Q=_[L];if(m(Q)){const $=S(b),Te=n.get(Q).__webglTexture;t.bindTexture($,Te),p($),t.unbindTexture()}}}const et=[],Be=[];function ft(b){if(b.samples>0){if(pt(b)===!1){const _=b.textures,L=b.width,K=b.height;let Q=i.COLOR_BUFFER_BIT;const $=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Te=n.get(b),ce=_.length>1;if(ce)for(let Ie=0;Ie<_.length;Ie++)t.bindFramebuffer(i.FRAMEBUFFER,Te.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ie,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Te.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ie,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Te.__webglMultisampledFramebuffer);const ye=b.texture.mipmaps;ye&&ye.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Te.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Te.__webglFramebuffer);for(let Ie=0;Ie<_.length;Ie++){if(b.resolveDepthBuffer&&(b.depthBuffer&&(Q|=i.DEPTH_BUFFER_BIT),b.stencilBuffer&&b.resolveStencilBuffer&&(Q|=i.STENCIL_BUFFER_BIT)),ce){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Te.__webglColorRenderbuffer[Ie]);const te=n.get(_[Ie]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,te,0)}i.blitFramebuffer(0,0,L,K,0,0,L,K,Q,i.NEAREST),l===!0&&(et.length=0,Be.length=0,et.push(i.COLOR_ATTACHMENT0+Ie),b.depthBuffer&&b.resolveDepthBuffer===!1&&(et.push($),Be.push($),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Be)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,et))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ce)for(let Ie=0;Ie<_.length;Ie++){t.bindFramebuffer(i.FRAMEBUFFER,Te.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ie,i.RENDERBUFFER,Te.__webglColorRenderbuffer[Ie]);const te=n.get(_[Ie]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Te.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ie,i.TEXTURE_2D,te,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Te.__webglMultisampledFramebuffer)}else if(b.depthBuffer&&b.resolveDepthBuffer===!1&&l){const _=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function I(b){return Math.min(s.maxSamples,b.samples)}function pt(b){const _=n.get(b);return b.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function Ye(b){const _=o.render.frame;h.get(b)!==_&&(h.set(b,_),b.update())}function nt(b,_){const L=b.colorSpace,K=b.format,Q=b.type;return b.isCompressedTexture===!0||b.isVideoTexture===!0||L!==vi&&L!==Rn&&(Xe.getTransfer(L)===Ze?(K!==Jt||Q!==Yt)&&De("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):We("WebGLTextures: Unsupported texture color space:",L)),_}function be(b){return typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement?(c.width=b.naturalWidth||b.width,c.height=b.naturalHeight||b.height):typeof VideoFrame<"u"&&b instanceof VideoFrame?(c.width=b.displayWidth,c.height=b.displayHeight):(c.width=b.width,c.height=b.height),c}this.allocateTextureUnit=U,this.resetTextureUnits=z,this.setTexture2D=G,this.setTexture2DArray=k,this.setTexture3D=H,this.setTextureCube=J,this.rebindTextures=ot,this.setupRenderTarget=He,this.updateRenderTargetMipmap=je,this.updateMultisampleRenderTarget=ft,this.setupDepthRenderbuffer=Ne,this.setupFrameBufferTexture=ne,this.useMultisampledRTT=pt,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Jm(i,e){function t(n,s=Rn){let r;const o=Xe.getTransfer(s);if(n===Yt)return i.UNSIGNED_BYTE;if(n===Fo)return i.UNSIGNED_SHORT_4_4_4_4;if(n===No)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Vc)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===kc)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===zc)return i.BYTE;if(n===Bc)return i.SHORT;if(n===Bi)return i.UNSIGNED_SHORT;if(n===Uo)return i.INT;if(n===an)return i.UNSIGNED_INT;if(n===nn)return i.FLOAT;if(n===vn)return i.HALF_FLOAT;if(n===Gc)return i.ALPHA;if(n===Hc)return i.RGB;if(n===Jt)return i.RGBA;if(n===Mn)return i.DEPTH_COMPONENT;if(n===Hn)return i.DEPTH_STENCIL;if(n===Wc)return i.RED;if(n===Oo)return i.RED_INTEGER;if(n===xi)return i.RG;if(n===zo)return i.RG_INTEGER;if(n===Bo)return i.RGBA_INTEGER;if(n===Cs||n===Ps||n===Is||n===Ds)if(o===Ze)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Cs)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Ps)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Is)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Ds)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Cs)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Ps)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Is)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Ds)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Xr||n===qr||n===Yr||n===jr)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Xr)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===qr)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Yr)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===jr)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===$r||n===Kr||n===Zr||n===Jr||n===Qr||n===eo||n===to)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===$r||n===Kr)return o===Ze?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Zr)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===Jr)return r.COMPRESSED_R11_EAC;if(n===Qr)return r.COMPRESSED_SIGNED_R11_EAC;if(n===eo)return r.COMPRESSED_RG11_EAC;if(n===to)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===no||n===io||n===so||n===ro||n===oo||n===ao||n===co||n===lo||n===ho||n===uo||n===fo||n===po||n===mo||n===go)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===no)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===io)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===so)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===ro)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===oo)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===ao)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===co)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===lo)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===ho)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===uo)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===fo)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===po)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===mo)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===go)return o===Ze?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===_o||n===xo||n===vo)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===_o)return o===Ze?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===xo)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===vo)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Mo||n===yo||n===So||n===bo)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Mo)return r.COMPRESSED_RED_RGTC1_EXT;if(n===yo)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===So)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===bo)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Vi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const Qm=`
void main() {
